  ...
  return (
    <section className="flex flex-col items-center justify-center h-full w-full bg-white relative ">
      ...
      <div className="h-full absolute top-96 flex flex-col items-center justify-center">
        <h1 className="text-[10rem] md:text-[20rem] bg-gradient-to-r from-slate-50 via-slate-200 to-slate-50 font-semibold inline-block text-transparent bg-clip-text transition-class">
          PRODUCT
        </h1>
        <div className="flex flex-col text-center absolute">
          <h3 className="text-2xl font-medium mb-1">Coming Soon</h3>
